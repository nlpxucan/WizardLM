...
- 🔥🔥🔥 [7/25/2023] We released **WizardLM V1.2** models. The **WizardLM-13B-V1.2** is here ([Demo_13B-V1.2](https://38ed9d5601fb8d00.gradio.app), [Demo_13B-V1.2_bak-1](https://4f32bb9d668b6cdf.gradio.app), [Full Model Weight](https://huggingface.co/WizardLM/WizardLM-13B-V1.2)). **WizardLM-7B-V1.2**,  and **WizardLM-70B-V1.0** are coming soon.
