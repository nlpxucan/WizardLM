...
- 🔥 We released **7B** version of **WizardLM** trained with **70k** evolved instructions. Checkout the [paper](https://arxiv.org/abs/2304.12244) and [demo](https://6f8173a3550ed441ab.gradio.live), [demo_bak](https://261f01fdd31bfe1ca0.gradio.live/).
...
## Call for Feedbacks
We welcome everyone to use your professional and difficult insturctions to evaluate WizardLM, and show us examples of poor performance and your suggestions in the [issue discussion](https://github.com/nlpxucan/WizardLM/issues) area. We are focusing on improving the Evol-Instruct now and hope to relieve existing issues in the the next version of WizardLM. After that, we will open the code and pipeline of new Evol-Instruct algorithm and work with you together to improve it.
