...
- 🔥 We released **7B** version of **WizardLM** trained with **70k** evolved instructions. Checkout the [paper](https://arxiv.org/abs/2304.12244) and [demo1](https://487706ba2456b3ec18.gradio.live) , [demo2](https://81189ea0b66d14f256.gradio.live)
...
[Demo Link](https://487706ba2456b3ec18.gradio.live)
...
The resources, including code, data, and model weights, associated with this project are strictly limited to academic research purposes and cannot be used for commercial purposes. The content produced by any version of WizardLM is influenced by uncontrollable variables such as randomness, and as a result, the accuracy of the output cannot be guaranteed by this project. This project does not accept any legal liability for the content of the model output, nor does it assume responsibility for any losses incurred due to the use of associated resources and output results.
