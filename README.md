...
- 🔥🔥🔥 We released **WizardCoder-15B-V1.0** (trained with **78k** evolved code instructions), which surpasses **Claude-Plus (+6.8)**, **Bard (+15.3)** and **InstructCodeT5+ (+22.3)** on the [HumanEval Benchmarks](https://github.com/openai/human-eval). For more details (Paper, [Demo (Only support English now.)](https://ac628d38689ebf91.gradio.app/), [Backup Demo1](https://59fcfe1c0e96316c.gradio.app/), [Backup Demo2](https://ff00756852e53f15.gradio.app/), [Backup Demo3](https://17184fe2eb7c1f6c.gradio.app/), [Model Weights](https://huggingface.co/WizardLM/WizardCoder-15B-V1.0)), please refer to [WizardCoder](https://github.com/nlpxucan/WizardLM/tree/main/WizardCoder).
